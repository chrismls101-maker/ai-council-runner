...
import { GLASS_IDE_REVEAL_HUNK_EVENT } from "../../shared/glassIdeHunkSync.ts";
...
export function GlassIdeEditorPane({
  ...
  useEffect(() => {
    const focusEditor = (): void => setCenterTab("editor");
    window.addEventListener(GLASS_IDE_REVEAL_HUNK_EVENT, focusEditor);
    return () => window.removeEventListener(GLASS_IDE_REVEAL_HUNK_EVENT, focusEditor);
  }, []);
