...
export type SwarmCameraLayout = "default" | "boot" | "onboarding" | "activation";

/** Compact right-rail — Aletheia key-wait manifestation. */
const ACTIVATION_BASE_Z = 5.4;
const ACTIVATION_CAM_Y = -0.38;
const ACTIVATION_LOOK_Y = 0.06;
...
function cameraTargets(layout: SwarmCameraLayout): { baseZ: number; camY: number; lookY: number } {
  switch (layout) {
    ...
    case "activation":
      return { baseZ: ACTIVATION_BASE_Z, camY: ACTIVATION_CAM_Y, lookY: ACTIVATION_LOOK_Y };
    default:
