...
const FULLSCREEN_WORKSPACE_SELECTOR =
  ".research-explorer, .code-analyst-explorer, .writing-studio, .glass-storage-projects, .glass-spaces-workspace, .glass-dashboard-shell:not(.glass-dashboard-shell--hidden), .aletheia-dashboard-shell:not(.aletheia-dashboard-shell--hidden)";
